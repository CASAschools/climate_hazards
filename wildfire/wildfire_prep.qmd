...
## repeating the process for the 2012 version of the data
...
## comparing the two rasters

subtracting to see what the difference is. Some have values like -5, which could only arise from areas that are developed now (a value of 0), and used to be in the very high risk category.

```{r}
whp_reclass <- rast("/capstone/casaschools/wildfire/intermediate_layers/whp_reclass.tif")

# Resample 'whp_reclass2012' to match the extent and resolution of 'whp_reclass'
whp_reclass2012_resampled <- resample(whp_reclass2012, whp_reclass, method = "near")

# Perform the subtraction
whp_increase <- whp_reclass - whp_reclass2012_resampled

plot(whp_reclass)

plot(whp_reclass2012)
