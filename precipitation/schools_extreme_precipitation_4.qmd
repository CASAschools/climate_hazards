...
data_dir_precip45 <- tools::R_user_dir("pr45", which = "data45")
schools_dir_precip45 <- file.path(data_dir_precip45, "schools_pr45") %>% normalizePath(mustWork = FALSE)
if (!file.exists(schools_dir_precip45)) dir.create(schools_dir_precip45, recursive = TRUE)
...
write.csv(ca_schools, "/capstone/casaschools/output_data/35_65_rcp4_day_totals_precip.csv")

write.csv(ca_schools, "output_data/35_65_rcp4_day_totals_precip.csv")
...
#   
 ...
 # Export total extreme precipitation days per year
write.csv(ca_schools, "/capstone/casaschools/output_data/06_34_rcp4_day_totals_precip.csv")

write.csv(ca_schools, "output_data/06_34_rcp4_day_totals_precip.csv")
