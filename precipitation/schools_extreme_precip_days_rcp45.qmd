...
There is one inactive school in the 2022-2023 school year that needs to be removed before working on getting maximum precipitation.
...
# write.csv(ca_schools, "/capstone/casaschools/precipitation/midcentury45.csv")
# 
# write.csv(ca_schools, "precipitation/midcentury45.csv")
# 
# #Export Extreme Precipitation Totals per year for Mid Century Scenario
# 
# write.csv(ca_schools_et_year, "/capstone/casaschools/precipitation/midcentury45_year.csv" )
# 
# write.csv(ca_schools_et_year, "precipitation/midcentury45_year.csv" )

```

#### RCP 4.5 CURRENT CENTURY 2006 to 2034
...
```{r}
#Export Extreme Precipitation Totals for Current Century Scenario

# write.csv(ca_schools, "/capstone/casaschools/precipitation/curcentury45.csv")
# 
# write.csv(ca_schools, "precipitation/curcentury45.csv")
# 
# #Export Extreme Precipitation Totals per year for Current Century Scenario
# 
# write.csv(ca_schools_et_year, "/capstone/casaschools/precipitation/curcentury45_year.csv" )
# 
# write.csv(ca_schools_et_year, "precipitation/curcentury45_year.csv" )
```
