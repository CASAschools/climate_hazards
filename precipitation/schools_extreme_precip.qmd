...
write.csv(ca_schools, "/capstone/casaschools/precipitation/midcentury8.5_precip_sum.csv")

write.csv(ca_schools, "precipitation/midcentury8.5_precip_sum.csv")

write.csv(ca_schools_et_year, "/capstone/casaschools/precipitation/midcentury8.5_precip_yeartotals.csv")

write.csv(ca_schools_et_year, "precipitation/midcentury8.5_precip_yeartotals.csv")
```

## Current Century 06 - 34
...
```{r}
# Export total extreme precipitation days per year
write.csv(ca_schools, "/capstone/casaschools/precipitation/currentcent8.5_precip_sum.csv")

write.csv(ca_schools, "precipitation/currentcent8.5_precip_sum.csv")

write.csv(ca_schools_et_year, "/capstone/casaschools/precipitation/currentcent8.5_precip_yeartotals.csv")

write.csv(ca_schools_et_year, "precipitation/currentcent8.5_precip_yeartotals.csv")
```
...
```{r}
# Export total extreme precipitation days per year
write.csv(ca_schools, "/capstone/casaschools/precipitation/hist8.5_precip_sum.csv")

write.csv(ca_schools, "precipitation/hist8.5_precip_sum.csv")

write.csv(ca_schools_et_year, "/capstone/casaschools/precipitation/hist8.5_precip_yeartotals.csv")

write.csv(ca_schools_et_year, "precipitation/hist8.5_precip_yeartotals.csv")
```
...
#precip_00_06 <- read.csv("/capstone/precipitation/hist8.5_precip_yeartotals.csv")


precip_rcp85_2006_2034 <- read.csv("/capstone/casaschools/precipitation/currentcent8.5_precip_yeartotals.csv")

precip_rcp85_2035_2064 <- read.csv("/capstone/casaschools/precipitation/midcentury8.5_precip_yeartotals.csv")


## Combine to make rcp45 2000-2064
precip_rcp85_2006_2064 <- rbind(precip_rcp85_2006_2034, 
                              precip_rcp85_2035_2064)

precip_rcp85_2006_2064 <- precip_rcp85_2006_2064

### export csv to shinydashboard data
write.csv(precip_rcp85_2006_2064, "/capstone/casaschools/shiny_dashboard/data/precipitation/precip_rcp85_2006_2064.csv")
```
