...
heat_rcp85_2000_2064_zeros <- heat_rcp85_2000_2064 %>% 
  group_by(CDSCode, year, total) %>% 
...
<<<<<<< HEAD:extreme_heat/schools_extreme_heat_days.qmd
...
rcp45 <- rcp45 %>% 
  mutate(scenario = "Intermediate scenario",
         total = round(total)) %>% 
...
# Export dataset into shiny dashboard
write.csv(extreme_heat,"/capstone/casaschools/shiny_dashboard/data/extreme_heat/extreme_heat.csv")
>>>>>>> ce6707a1da5598a6a6cc66519caf7d89531af433:extreme_heat/schools_extreme_heat_days_rcp85.qmd
```
