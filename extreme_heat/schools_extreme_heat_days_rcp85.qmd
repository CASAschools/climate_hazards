...
extreme_heat_zeros <- extreme_heat %>% 
  group_by(CDSCode, year, total, scenario) %>% 
...
write.csv(extreme_heat_zeros,"/capstone/casaschools/shiny_dashboard/data/extreme_heat/extreme_heat_zeros.csv")
```
